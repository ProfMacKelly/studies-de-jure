...
| Gap-Filler Provision | Subject  | Description                                                                                                                                                                                                                                                                              |
| -------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| § 2-305              | Price    | <ul><li>Price can be left open to be fixed at later time</li><li>Reasonable price determined upon delivery</li></ul>                                                                                                                                                                     |
| § 2-306              | Quantity | <ul><li>“Output” and “Requirement” amounts can be determined at a later time</li><li>No quantity that is unreasonably disproportionate to the estimate will be enforced</li><li>Reasonable amount in keeping with normal or prior comparable output or requirements is implied</li></ul> |
...
UCC § 2-207 still requires the parties to intend to create a contract. If the differing forms show that the parties never reached an agreement, then no contract exists.

...
Except where otherwise noted, this page's content is adapted from [Performance](https://pressbooks.pub/introductiontobusinesslaw/chapter/chapter-11/) in [_Fundamentals of Business Law_ ](https://pressbooks.pub/introductiontobusinesslaw/)by Melissa Randall (2020), used under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).

...
Our cases also make plain that "\[f]or executive officers in general, . . . qualified immunity represents the norm." _Harlow,_ [_supra_](#user-content-fn-7)[^7]_,_ at 807.[<sup>\[2\]</sup>](malley-v.-briggs.md#footnotes) Like federal officers, state officers who "seek absolute exemption from personal liability for unconstitutional conduct must bear the burden of showing that public policy requires an exemption of that scope." _Butz_ v. _Economou,_ [438 U.S. 478](https://www.courtlistener.com/opinion/109932/butz-v-economou/), 506 (1978).

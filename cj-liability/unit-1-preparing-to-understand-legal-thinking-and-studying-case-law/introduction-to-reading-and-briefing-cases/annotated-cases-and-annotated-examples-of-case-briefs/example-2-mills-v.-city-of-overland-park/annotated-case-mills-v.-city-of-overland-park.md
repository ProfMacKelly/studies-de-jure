...
{% hint style="info" %}
<mark style="color:red;">**Note that the next couple of paragraphs also include a bunch of facts that are relevant to the case. Courts do not always put all the relevant facts in the case section of the case.**</mark>
{% endhint %}
...
[Annotated Case: _Mills v. City of Overland Park_](annotated-case-mills-v.-city-of-overland-park.md) © 2024 by Matthew L. Mac Kelly is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1), except where otherwise noted.

...
In [_Wellington v. Daniels_](#user-content-fn-1)[^1]_,_ we declined to adopt the gross negligence standard employed by some appellate courts for judging municipal liability and held:
...
\[\*] In [_Spell v. McDaniel_](#user-content-fn-2)[^2]_,_ decided after the trial of the case [_sub judice_](#user-content-fn-3)[^3]_,_ we reiterated our _Wellington_ holding in a case specifically involving police training, stating:
...
In a recent decision, [_City of Canton v. Harris_](#user-content-fn-4)[^4]_, &#x74;_&#x68;e Supreme Court adopted the “deliberate indifference” standard for determining when a municipality may be held liable in “failure to train” cases.
...
[^1]: 717 F.2d 932 (4th Cir.1983)

[^2]: 824 F.2d 1380 (1987)

[^3]: A matter or case that is before a judge or court for determination.[\[\*\]](https://thelawdictionary.org/sub-judice/)

[^4]: [489 U.S. 378](https://www.courtlistener.com/opinion/112209/canton-v-harris/), 388 (1989),

...
Use the table of contents in the left sidebar to browse through the resources. Click on any section or subsection to view its content. Scroll down to read the entire page.

{% hint style="info" %}
<mark style="color:$primary;">**Pages with multiple headings/subsections have their own table of contents on the right side of the page.**</mark> (For example, see the right side of this screen.) The table on the right might not appear on smaller screens, such as phones and small tablets.
{% endhint %}
...
{% hint style="info" %}
<mark style="color:$primary;">**Click the link to learn more about using GitBook's**</mark> [<mark style="color:blue;">**Search & Quick find**</mark> <mark style="color:$primary;">**tool**</mark>](https://docs.gitbook.com/content-editor/searching-your-content/quick-find)<mark style="color:red;">.</mark>
{% endhint %}
...
{% hint style="info" %}
<mark style="color:$primary;">You may also quickly access this tool by pressing</mark> <mark style="color:$primary;"></mark><mark style="color:$primary;">**Ctrl + K**</mark> <mark style="color:$primary;"></mark><mark style="color:$primary;">on a PC or</mark> <mark style="color:$primary;"></mark><mark style="color:$primary;">**⌘ + K**</mark> <mark style="color:$primary;"></mark><mark style="color:$primary;">on a Mac.</mark>
{% endhint %}
...
<summary>Other Attributions and Licensing</summary>

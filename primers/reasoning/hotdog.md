...
Is a hot dog a sandwich? Is a sandwich even a sandwich? The answer to both questions is: It depends. It depends on the premises in a [**deductive reasoning**](deductive.md) formula (rules and facts) and—as we will see below—some [**analogical reasoning**](analogical.md).

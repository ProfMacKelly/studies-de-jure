...
## Is a hot dog a sandwich? Is a sandwich even a sandwich? The answer to both questions is: It depends. It depends on the premises in a [**deductive reasoning**](https://github.com/mmackelly23/Casebooks/blob/BusLaw/unit-1-preparing-to-understand-legal-thinking-and-studying-case-law/1.1-primers-on-legal-thinking-reasoning-and-analysis/1.2.1-introduction-to-deductive-rule-based-reasoning.md) formula (rules and facts) and—as we will see below—some [**analogical reasoning**](https://github.com/mmackelly23/Casebooks/blob/BusLaw/unit-1-preparing-to-understand-legal-thinking-and-studying-case-law/1.1-primers-on-legal-thinking-reasoning-and-analysis/1.2.2-introduction-to-analogical-reasoning-a-type-of-inductive-reasoning.md).
...
Except where otherwise noted, [Is a Hot Dot a Sandwich?](https://github.com/mmackelly23/Casebooks/blob/BusLaw/unit-1-preparing-to-understand-legal-thinking-and-studying-case-law/1.1-primers-on-legal-thinking-reasoning-and-analysis/1.2.3-is-a-hot-dog-a-sandwich.md) by Matthew L. Mac Kelly is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1).
...
\>>>>>>> Stashed changes\
\=======\
\>>>>>>> Stashed changes<mark style="color:red;">**License**</mark>

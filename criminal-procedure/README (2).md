...
[^3]: Such as this: [**How Annotations Work in This Sourcebook**](<README (2).md#how-annotations-work-in-this-sourcebook>), below. Click the carrot (**>**) on the left side of the widget to expand and reveal its contents.

...
There are different legal reasoning/analysis methods, but professionals most commonly engage in both (1) **deductive reasoning** (i.e., syllogistic reasoning) and (2) [**inductive reasoning**](/broken/pages/MhvI68x7ZQnGFuveMuFp) (in our context, this is reasoning by analogy).&#x20;
...
In daily conversations, political arguments, legal reasoning (including [judicial opinions](#user-content-fn-13)[^13]), etc., enthymemes are common. For example[^14]:
...
But enthymemes must be treated [with caution](#user-content-fn-13)[^13] because some people may use them unintentionally or intentionally as [hasty generalizations](#user-content-fn-15)[^15], or sometimes, to mislead someone that a false premise is actually true. Hasty generalizations and false premises can lead to fundamentally flawed conclusions. For example[^16]:&#x20;
...
Moving into the legal context in its plainest form, a legal syllogism in criminal cases [looks like this](#user-content-fn-18)[^18]:&#x20;
...
Here is a [legal example](#user-content-fn-19)[^19]:
...
Here is a [legal example](#user-content-fn-20)[^20] of a polysyllogism:
...
>
> **Fact 2 (a "variable"):** Evidence[^21] from the investigation demonstrated that Jospeh shot and killed Henry inside Henry's home.
>
> **Fact 3 (a "variable"):** [Evidence ](#user-content-fn-21)[^21]from the investigation demonstrated that before killing Henry, Joseph broke into Henry's home, waited for Henry to return.
>
> **Fact 4 (a "variable"):** [Evidence ](#user-content-fn-21)[^21]from the investigation demonstrated Joseph did not act in self-defense at the time he killed Henry.
>
> **Analysis:**&#x20;
>
...
Common to judicial opinions, some arguments require a little extra work to find the syllogism.\*[^22] For example, based on the question of whether there is a constitutional right to an abortion, in [_Roe v. Wade_](#user-content-fn-23)[^23], the majority wrote:
...
Now that we have taken a look at deductive or rule-based reasoning, we will move on to a type of inductive reasoning: [**analogical reasoning**](/broken/pages/MhvI68x7ZQnGFuveMuFp).
...
[Introduction to Deductive (Rule-Based) Reasoning](/broken/pages/9LV0b7VWwKziGEkDFktE) © 2024 by Matthew L. Mac Kelly is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1), except where otherwise noted.

</details>



[^1]: See [Syllogisms](1.1.1-introduction-to-deductive-rule-based-reasoning.md#syllogisms); [Kulicki (2020)](/broken/pages/dV3xLCLuJyIuIcQAKHDQ).

[^2]: [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 3.

[^3]: [Swisher](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 537, 539 n.18.

[^4]: i.e., humans

[^5]: i.e., human

[^6]: [Fields ](/broken/pages/iqcdIo23Rt4wBOoMIAFr)(2024).

[^7]: This example is adapted from [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 10.
...
[^9]: [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 9.

[^10]: [Aldisert et al.](/broken/pages/dV3xLCLuJyIuIcQAKHDQ), 9.

[^11]: [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 8; [Nordquist (2018)](/broken/pages/iqcdIo23Rt4wBOoMIAFr).&#x20;

[^12]: [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 8.

[^13]: [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 8.

[^14]: Literary Terms, [_Enthymeme_](https://literaryterms.net/enthymeme/) (last visited June 20, 2024).

[^15]: [Ramee ](/broken/pages/iqcdIo23Rt4wBOoMIAFr)(2002); [Nordquist ](/broken/pages/iqcdIo23Rt4wBOoMIAFr)(2019).

[^16]: Literary Terms, [_Enthymeme_](https://literaryterms.net/enthymeme/) (last visited June 20, 2024).

[^17]: See generallly, [Ramee](/broken/pages/iqcdIo23Rt4wBOoMIAFr).

[^18]: See [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 6.

[^19]: This example is adapted from [Swisher](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 536.&#x20;

[^20]: [Swisher](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 536.

[^21]: For the purposes of this exercise, investigators or the prosecution would have already performed other reasoning to draw this conclusion from the evidence.

[^22]: [Aldisert et al.](/broken/pages/iqcdIo23Rt4wBOoMIAFr), 7.

[^23]: The fact that [_Roe v. Wade_](https://scholar.google.com/scholar_case?case=12334123945835207673\&q=roe+v.+wade\&hl=en\&as_sdt=6,50) was overturned by [_Dobbs v. Jackson Women's Health Organization_](https://scholar.google.com/scholar_case?case=10996775398954026979\&hl=en\&as_sdt=6,50) in 2022 does not affect the purpose and legitimacy of this example.
